...
`[Unreleased]` or the current version, conflict markers, a missing blank line
before a heading) via `.github/scripts/check_changelog.sh`; it cannot tell
whether an entry sits under the *right* heading.
